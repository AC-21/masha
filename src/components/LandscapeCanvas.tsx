  ...
  return (
    <div className="relative w-full" style={{ backgroundColor: '#FEFEF7' }}>
      ...
      <ScaleFrame id="desktop-canvas" testId="desktop-canvas" designWidth={1650} designHeight={1900} minScale={0} maxScale={1} className="mx-auto w-full">
        ...
        <div className="absolute left-[100px] top-[1050px] w-[800px] h-[100px]" style={{ pointerEvents: 'none', zIndex: 5 }}>
        ...
        {(() => {
          ...
          <div id="calendly" className="absolute left-[800px] top-[1046px] w-[750px] h-[770px] overflow-visible relative z-20">
            <CalendlyEmbed 
              height={770} 
              rounded={0} 
              primaryColor="3b5849" 
