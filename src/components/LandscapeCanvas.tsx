...
export default function LandscapeCanvas() {
  return (
    <ScaleFrame id="desktop-canvas" testId="desktop-canvas" designWidth={1650} designHeight={1827} minScale={0.9} maxScale={1} className="mx-auto w-full overflow-hidden">
