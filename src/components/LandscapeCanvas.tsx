  ...
  return (
    <div className="relative w-full" style={{ backgroundColor: '#FEFEF7' }}>
      <ScaleFrame id="desktop-canvas" testId="desktop-canvas" designWidth={1650} designHeight={1900} minScale={0} maxScale={1} className="mx-auto w-full">
        ...
        <div className="absolute text-black font-bold font-['Roboto_Mono'] uppercase leading-9" style={{ left: '784px', top: '82px', width: '763px' }}>
          One Sentence that lets people know what
          <br />
          The good word is.
        </div>
        {/* Body text block */}
        <div className="absolute left-[788px] top-[185px] w-[746px] text-black text-sm font-medium font-['Inter'] lowercase leading-7">
        ...
        {/* Portrait */}
        <picture className="absolute left-[122px] top-[86px] block" style={{ width: '581px', height: '775px', borderRadius: 37, overflow: 'hidden' }}>
