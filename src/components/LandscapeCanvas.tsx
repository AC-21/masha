  ...
  return (
    <div className="relative w-full" style={{ backgroundColor: '#FEFEF7' }}>
      <ScaleFrame id="desktop-canvas" testId="desktop-canvas" designWidth={1650} designHeight={1950} minScale={0} maxScale={1} className="mx-auto w-full">
        ...
        {/* Portrait */}
        <picture className="absolute left-[122px] top-[136px] block" style={{ width: '581px', height: '775px', borderRadius: 37, overflow: 'hidden' }}>
        ...
        <div className="absolute left-[159px] top-[1145px] w-[650px] text-black/70 text-xs font-['Inter'] italic leading-5">
        ...
        <div className="absolute left-[159px] top-[1250px] text-black text-2xl font-bold font-['Roboto_Mono'] uppercase leading-7">Movement</div>
        <div className="absolute left-[430px] top-[1250px] text-black text-2xl font-bold font-['Roboto_Mono'] uppercase leading-7">Laughter</div>
        <div className="absolute left-[159px] top-[1450px] text-black text-2xl font-bold font-['Roboto_Mono'] uppercase leading-7">Parts</div>
        <div className="absolute left-[430px] top-[1450px] text-black text-2xl font-bold font-['Roboto_Mono'] uppercase leading-7">Deep Connection</div>
        {/* Sample bullets - Movement */}
        <div className="absolute left-[189px] top-[1292px] w-[220px] text-black text-sm font-bold font-['Roboto_Mono'] uppercase leading-7">
          Some text on what it is<br/>Some text on what it is<br/>Some text on what it is
        </div>
        <div className="absolute left-[189px] top-[1386px] w-[220px] text-black text-sm font-bold font-['Roboto_Mono'] uppercase leading-7">
          Some text on who its for<br/>Some text on who its for
        </div>
        
        {/* Sample bullets - Laughter */}
        <div className="absolute left-[460px] top-[1292px] w-[220px] text-black text-sm font-bold font-['Roboto_Mono'] uppercase leading-7">
          Some text on what it is<br/>Some text on what it is<br/>Some text on what it is
        </div>
        <div className="absolute left-[460px] top-[1386px] w-[220px] text-black text-sm font-bold font-['Roboto_Mono'] uppercase leading-7">
          Some text on who its for<br/>Some text on who its for
        </div>
        
        {/* Sample bullets - Parts */}
        <div className="absolute left-[189px] top-[1492px] w-[220px] text-black text-sm font-bold font-['Roboto_Mono'] uppercase leading-7">
          Some text on what it is<br/>Some text on what it is<br/>Some text on what it is
        </div>
        <div className="absolute left-[189px] top-[1586px] w-[220px] text-black text-sm font-bold font-['Roboto_Mono'] uppercase leading-7">
          Some text on who its for<br/>Some text on who its for
        </div>
        
        {/* Sample bullets - Deep Connection */}
        <div className="absolute left-[460px] top-[1492px] w-[220px] text-black text-sm font-bold font-['Roboto_Mono'] uppercase leading-7">
          Some text on what it is<br/>Some text on what it is<br/>Some text on what it is
        </div>
        <div className="absolute left-[460px] top-[1586px] w-[220px] text-black text-sm font-bold font-['Roboto_Mono'] uppercase leading-7">
          Some text on who its for<br/>Some text on who its for
        </div>
