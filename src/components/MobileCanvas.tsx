  ...
  return (
    <ScaleFrame designWidth={384} designHeight={1433} className="mx-auto max-w-[420px]">
      <div className="relative w-96 h-[1433px] bg-stone-50 overflow-hidden">
        ...
        {/* Portrait */}
        <img src="/images/portrait-480.jpg" alt="Portrait" width="279" height="372" className="absolute left-[46px] top-[84px] w-72 h-96 rounded-xl object-cover" decoding="async" />
        {/* Section title */}
